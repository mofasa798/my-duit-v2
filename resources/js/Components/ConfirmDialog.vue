    ...
    <Teleport to="body">
        <Transition name="dialog">
            ...
            >
                ...
                <!-- Dialog box -->
                <div class="relative z-10 mx-4 w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
                    <!-- Icon -->
                    <div
                    ...
                    <!-- Title -->
                    <h3 class="mb-2 text-center text-lg font-bold text-gray-800">{{ title }}</h3>
                    <p class="mb-6 text-center text-sm text-gray-500">{{ message }}</p>
